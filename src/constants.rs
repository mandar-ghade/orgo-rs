...
lazy_static! {
    ...
    pub static ref ELEMENT_WEIGHTS: [f64; 118] = [
        ...
        44.96, 47.88, 50.94, 52.00, 54.94, 55.85, 58.93, 58.69, 63.55, 65.39,
        69.72, 72.59, 74.92, 78.96, 79.90, 83.80, 85.47, 87.62, 88.91, 91.22,
        92.91, 95.94, 99.0, 101.1, 102.9, 106.4, 107.9, 112.4, 114.8, 118.7,
        121.8, 127.6, 126.9, 131.3, 132.9, 137.3, 138.9, 140.1, 140.9, 144.2,
        145.0, 150.4, 152.0, 157.2, 158.9, 162.5, 164.9, 167.3, 168.9, 173.0,
        ...
        258.0, 259.0, 260.0, 261.0, 262.0, 266.0, 264.0, 277.0, 268.0, 281.0,
        272.0, 285.0, 284.0, 289.0, 288.0, 291.0, 294.0, 294.0,
    ];
}
